...
# sys.path.append('/home/mingyyan/AMD-Hybrid-Models/X-EcoMLA')
...
def main():
    ...
    model = MLATransformerHybridModelWrapper.from_pretrained(args.model_path, torch_dtype=torch.bfloat16).cuda()
